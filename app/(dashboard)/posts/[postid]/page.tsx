...
export default function PostPage() {
  ...
  // FIXED: Use postid to match your folder name [postid]
    ...
    const fetchPost = async () => {
      ...
      try {
        ...
        if (docSnap.exists()) {
          ...
          setError(`Post with ID "${postId}" not found in database.`);
        }
      } catch (err) {
  ...
  // Also update your AllPosts page links to match:
  // <Link href={`/posts/${post.id}`}> should work since folder is [postid]
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 flex items-center justify-center px-4">
        <motion.div
          ...
          className="max-w-md w-full text-center bg-white rounded-2xl shadow-lg p-8"
        >
        ...
        >
          ...
          <div className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 text-white p-8 sm:p-12">
            ...
            <div className="relative z-10">
              ...
              {post?.updatedAt && (
                <div className="text-blue-200 text-sm border-t border-white/20 pt-4 mt-6">
              ...
              <div className="text-gray-700 leading-relaxed text-lg">
                {post?.content.split('\n').map((paragraph, index) => (
                  <motion.p
                    ...
                    className="mb-6 text-gray-800 leading-8"
                  >
                    {paragraph || <br />}
                  </motion.p>
                ))}
