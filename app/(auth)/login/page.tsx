...
export default function LogIn() {
  ...
  // Types added to enforce strict type safety
  const [
    signInWithEmailAndPassword,
    loadingEmail,
    errorEmail,
  ]: [
    (email: string, password: string) => Promise<UserCredential | null>,
    boolean,
    Error | undefined
          ...
          >
            <span className="w-5 h-5 flex items-center justify-center">
              ...
              <svg viewBox="0 0 533.5 544.3" xmlns="http://www.w3.org/2000/svg" className="w-5 h-5">
                ...
                <path d="M120 326.1c-10.8-32.2-10.8-66.8 0-99l-86.4-69.9C7.6 202.5 0 236.5 0 272s7.6 69.5 33.6 114.9l86.4-69.8z" fill="#FBBC05"/>
                <path d="M272 107.7c39.5 0 75 13.6 103 40.2l77.2-77.2C409.7 24.9 345.1 0 272 0 167.7 0 78.1 58.5 33.6 146.6l86.4 69.9C141.4 155.3 201.3 107.7 272 107.7z" fill="#EA4335"/>
              </svg>
            </span>
